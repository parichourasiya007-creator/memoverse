          ...
          <div className="rounded-2xl p-4 border border-[var(--oxblood)] bg-[var(--oxblood-light)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs font-bold text-[var(--text-secondary)]">{LANGUAGE_METADATA[lang]?.nativeName || lang} · {t.ai.level} {active.activities.level} · {active.activities.completed} {t.activities.completed}</div>
...
function ActivitiesScreen({ onNav }: { onNav: (s: Screen) => void }) {
  ...
  const filteredGames = activeCategory === (t.games.catAll || "All") || activeCategory === "All" ? ALL_GAMES : ALL_GAMES.filter((g) => g.category === activeCategory);
